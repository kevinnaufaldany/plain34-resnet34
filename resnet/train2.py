...
from restnet34 import create_resnet34
...
def main():
	"""
	Fungsi utama training dan validasi model resnet34.
	"""
	...
	plt.xlabel("Epoch")
	plt.ylabel("Loss")
	plt.title("Training & Validation Loss1 ResNet34")
	plt.legend()
	...
	plt.xlabel("Epoch")
	plt.ylabel("Accuracy")
	plt.title("Training & Validation Accuracy ResNet34")
	plt.legend()
